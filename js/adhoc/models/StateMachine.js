/**
 * The Finite Statemachine by Jake Gordon (http://codeincomplete.com)
...
var StateMachine = Backbone.Model.extend({
    ...
    initialize: function(cfg, target, view) {
    	
    //das object, das den eventbus führt muß hier hineingegeben werden, dann bindet die statemachine
    //die callbacks and je ein event mit fsm:xyz
    
    // also würde man dann auf einem button in der workspacetoolbar einfach this.workspace.trigger('fsm:xyz') aufrufen.
    //die konkrete fsm instanz muß dann über die view, also den workspace bescheidwissen, damit sie darauf arbeiten kann.
    //z.b. dinge einblenden, oder eine query feuern.
